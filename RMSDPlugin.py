...
class RMSDPlugin:
    ...
    def output(self, outputfile):
        ...
        os.system("singularity exec "+PyPluMA.prefix()+"/"+self.parameters["container"]+" python plugins/RMSD/run_RMSD.py --input_dir "+PyPluMA.prefix()+"/"+self.parameters["input_dir"]+" --output_dir "+outputfile)
